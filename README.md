...
- **Itinerario**: una sola vista combinada con el calendario y el mapa lado a lado (apilados en celular), más la tabla editable de los 14 días (fecha, lugar, tipo, notas) debajo.
  ...
  - **Detalle de un día**: clic en un día del calendario, un marcador del mapa, o doble clic en una fila de la tabla, abre una ventana con el detalle de ese día y sus **paradas extra** (ej: estando en Valdivia, ir un rato a Niebla) — se agregan con lugar + nota corta, y aparecen como puntos chicos en el mapa junto a la parada principal del día (no forman parte del trayecto ni se enrutan, son solo un ida y vuelta dentro del mismo día).
