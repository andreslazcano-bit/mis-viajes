...
- **Itinerario**: una sola vista combinada con el calendario y el mapa lado a lado (apilados en celular), más la tabla editable de los 14 días (fecha, lugar, tipo, notas) debajo.
  ...
  - **Detalle de un día**: clic en un día del calendario, un marcador del mapa, o doble clic en una fila de la tabla, abre una ventana con fecha/tipo/lugar/notas editables ahí mismo, flechas para pasar al día anterior/siguiente sin cerrarla, y las **paradas extra** de ese día (ej: estando en Valdivia, ir un rato a Niebla) — se agregan con lugar + nota corta, muestran si el lugar se reconoce mientras escribes y la distancia real por carretera desde la parada principal, y aparecen como puntos chicos en el mapa (no forman parte del trayecto ni se enrutan, son solo un ida y vuelta dentro del mismo día).
